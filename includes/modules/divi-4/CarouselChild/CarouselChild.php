<?php
class DTP_Carousel_Child extends DTP_Builder_Module
{
	public $slug                     = 'torq_carousel_child';
	...
	{
		$this->name = esc_html__('Torq Carousel Item', 'divitorque');
		...
		$this->settings_modal_toggles = array(
			...
			'advanced' => array(
				'toggles' => array(
					...
					'subtitle' => esc_html__('Subtitle Text', 'divitorque'),
		...
		$this->custom_css_fields = array(
			'image_wrap' => array(
				'label'    => esc_html__('Image Wrapper', 'divitorque'),
			...
			'title'      => array(
				...
				'selector' => '%%order_class%% .dtp-image-title',
			),
			'sub_title'  => array(
				'label'    => esc_html__('Sub Title', 'divitorque'),
				'selector' => '%%order_class%% .dtp-image-subtitle',
			),
			'button'     => array(
				'label'    => esc_html__('Button', 'divitorque'),
				'selector' => '%%order_class%% .dtp-btn-img-carousel',
			),
		);
	}
	...
	public function get_fields()
	{
		$fields = array(
			...
			'title'                 => array(
				'label'       => esc_html__('Title', 'divitorque'),
				'description' => esc_html__('Define the title text for the item.', 'divitorque'),
				'type'        => 'text',
				'toggle_slug' => 'content',
			),
			...
			'sub_title'             => array(
				...
				'description' => esc_html__('Define the sub-title text for the item.', 'divitorque'),
				'type'        => 'text',
				'toggle_slug' => 'content',
			),
			...
			'content_alignment'     => array(
				'label'            => esc_html__('Content Text Alignment', 'divitorque'),
				'description'      => esc_html__('Align texts to the left, right or center.', 'divitorque'),
				'type'             => 'text_align',
			...
			'content_width'         => array(
				'label'          => esc_html__('Content Width', 'divitorque'),
				'description'    => esc_html__('Define custom content width.', 'divitorque'),
				'type'           => 'range',
				'mobile_options' => true,
				'default'        => '100%',
			...
			'content_type'          => array(
				...
				'description' => esc_html__('Define content type. By selecting absolute type content can be placed as image overlay.', 'divitorque'),
				'type'        => 'select',
				'toggle_slug' => 'content',
				'tab_slug'    => 'advanced',
				'default'     => 'normal',
			...
			'content_position'      => array(
				'label'       => esc_html__('Content Position', 'divitorque'),
				'description' => esc_html__('Define content position.', 'divitorque'),
				'type'        => 'select',
				'toggle_slug' => 'content',
				'tab_slug'    => 'advanced',
				'default'     => 'bottom',
			...
			'content_pos_x'         => array(
				'label'       => esc_html__('Content Horizontal Placement', 'divitorque'),
				'description' => esc_html__('Select content horizontal placement.', 'divitorque'),
				'type'        => 'select',
				'toggle_slug' => 'content',
				'tab_slug'    => 'advanced',
				'default'     => 'center',
			...
			'content_offset_x'      => array(
				'label'          => esc_html__('Content Horizontal Position', 'divitorque'),
				'description'    => esc_html__('Define the value for the content horizontally offset.', 'divitorque'),
				'type'           => 'range',
				'default_unit'   => 'px',
				'default'        => '0px',
				'mobile_options' => true,
			...
			'content_pos_y'         => array(
				'label'       => esc_html__('Content Vertical Placement', 'divitorque'),
				'description' => esc_html__('Select content vertical placement.', 'divitorque'),
				'type'        => 'select',
				'toggle_slug' => 'content',
				'tab_slug'    => 'advanced',
				'default'     => 'center',
			...
			'content_offset_y'      => array(
				'label'          => esc_html__('Content Vertical Position', 'divitorque'),
				'description'    => esc_html__('Define the value for the content vertically offset.', 'divitorque'),
				'type'           => 'range',
				'default_unit'   => 'px',
				'default'        => '0px',
				'toggle_slug'    => 'content',
			...
			'content_padding'       => array(
				...
				'description'    => esc_html__('Define custom padding for the content area.', 'divitorque'),
				'type'           => 'custom_padding',
				'tab_slug'       => 'advanced',
				'toggle_slug'    => 'content',
				'mobile_options' => true,
	...
	public function get_advanced_fields_config()
	{
		...
		$advanced_fields['button']['button'] = array(
			'label'          => esc_html__('Button', 'divitorque'),
			'css'            => array(
				'main'      => '%%order_class%% .dtp-btn-img-carousel',
				'alignment' => '%%order_class%% .dtp-btn-wrap',
				'important' => 'all',
			),
			'tab_slug'       => 'advanced',
			'toggle_slug'    => 'button',
		...
		$advanced_fields['fonts']['title'] = array(
			'label'           => esc_html__('Title', 'divitorque'),
			'css'             => array(
				'main'      => '%%order_class%% .dtp-image-title, .et-db #et-boc %%order_class%% .dtp-image-title',
				'important' => 'all',
			),
			'tab_slug'        => 'advanced',
			'toggle_slug'     => 'title',
		...
		$advanced_fields['fonts']['subtitle'] = array(
			'label'           => esc_html__('Subtitle', 'divitorque'),
			'css'             => array(
				'main'      => '%%order_class%% .dtp-image-subtitle, .et-db #et-boc %%order_class%% .dtp-image-subtitle',
				'important' => 'all',
			),
			'tab_slug'        => 'advanced',
	...
	public function render_figure()
	{
		...
		if (!empty($photo)) {
			return sprintf(
				'<figure class="dtp-figure">
                    <div class="dtp-overlay"><i class="dtp-overlay-icon">%2$s</i></div>
                    <img class="dtp-swapped-img" data-mfp-src="%1$s" src="%1$s" alt="%3$s"/>
                </figure>',
				$photo,
				$overlay_icon,
				$photo_alt
	...
	public function render_title()
	{
		...
		if (!empty($title_text)) {
			return sprintf('<%2$s class="dtp-image-title">%1$s</%2$s>', $title_text, $processed_title_level);
		}
	}
	...
	public function render_subTitle()
	{
		...
		if (!empty($sub_title)) {
			return sprintf('<%2$s class="dtp-image-subtitle">%1$s</%2$s>', $sub_title, $processed_subtitle_level);
		}
	}
		...
		if ('on' === $this->props['use_button']) {
			...
			$button = $this->render_button(
				array(
					...
					'button_classname'    => array('dtp-btn-default', 'dtp-btn-img-carousel'),
					...
					'multi_view_data'     => $multi_view->render_attrs(
						array(
							'content'        => '{{button_text}}',
							'hover_selector' => '%%order_class%% .dtp-btn-img-carousel',
							'visibility'     => array(
	...
	public function render($attrs, $content, $render_slug)
	{
		...
		ET_Builder_Element::set_style(
			$render_slug,
			array(
				'selector'    => '%%order_class%% .dtp-image-carousel-item .content-inner',
		...
		if ('auto' !== $image_height) {
			ET_Builder_Element::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .dtp-image-carousel-item figure',
			...
			ET_Builder_Element::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .dtp-image-carousel-item figure img',
		...
		$this->get_responsive_styles(
			...
			'%%order_class%% .dtp-image-carousel-item h3',
		...
		ET_Builder_Element::set_style(
			$render_slug,
			array(
				'selector'    => '%%order_class%% .dtp-image-carousel-item .content .content-inner',
				'declaration' => sprintf(
					'%1$s',
		...
		$this->get_responsive_styles(
			'content_width',
			'%%order_class%% .dtp-image-carousel-item .content .content-inner',
			array('primary' => 'width'),
			array('default' => '100%'),
			$render_slug
		);
		...
		// Button Styles.
		$this->get_buttons_styles('button', $render_slug, '%%order_class%% .dtp-btn-wrap .dtp-btn-img-carousel');

		// Content background.
		$this->get_custom_bg_style($render_slug, 'content', '%%order_class%% .dtp-image-carousel-item .content .content-inner', '%%order_class%% .dtp-image-carousel-item .content .content-inner:hover');

		// Overlay Styles.
		$this->get_overlay_style($render_slug, 'photo', '%%order_class%% .dtp-image-carousel-item');
		...
		return sprintf(
			'<div class="dtp-carousel-item dtp-image-carousel-item dtp-swapped-img-selector dtp-hover--%3$s">
                %4$s %1$s %2$s
			</div>',
			$this->render_figure(),
