...
class TORQ_BasicListChild extends TORQ_Builder_Module
{
    ...
    public function render($attrs, $content, $render_slug)
    {
        ...
        $global_basic_list_titles[]  = $multi_view->get_values('title');
        $global_basic_list_class[] = ET_Builder_Element::get_module_order_class($render_slug);
