<?php
class DTP_Video_Modal extends DTP_Builder_Module
{

	public function init()
	{
		$this->slug       = 'torq_video_modal';
		$this->vb_support = 'on';
		$this->name       = esc_html__('Torq Video Modal', 'divitorque');
		$this->icon_path  = plugin_dir_path(__FILE__) . 'video-modal.svg';
		...
		$this->settings_modal_toggles = array(
			...
			'advanced' => array(
				'toggles' => array(
					...
					'popup' => esc_html__('Popup', 'divitorque'),
				),
			),
		);
		...
		$this->custom_css_fields = array(
			'image'        => array(
				...
				'selector' => '%%order_class%% .dtp-video-modal .dtp-video-modal-figure img',
			),
			'icon_wrapper' => array(
				'label'    => esc_html__('Icon Wrapper', 'divitorque'),
				'selector' => '%%order_class%% .dtp-video-modal .dtp-video-modal-icon',
			),
			'icon'         => array(
				'label'    => esc_html__('Icon', 'divitorque'),
				'selector' => '%%order_class%% .dtp-video-modal .dtp-video-modal-icon svg',
			),
			'text'         => array(
				'label'    => esc_html__('Text', 'divitorque'),
				'selector' => '%%order_class%% .dtp-video-modal .dtp-video-modal-text',
			),
		);
	}
	...
	public function get_fields()
	{
		$fields = array(
			'use_overlay'      => array(
				...
				'description'     => esc_html__('Here you can choose whether overlay image should be used.', 'divitorque'),
				'type'            => 'yes_no_button',
			...
			'image'            => array(
				'label'              => esc_html__('Image', 'divitorque'),
				'description'        => esc_html__('Here you can define placeholder image for the video.', 'divitorque'),
				'type'               => 'upload',
				'data_type'          => 'image',
			...
			'image_alt'        => array(
				...
				'description' => esc_html__('Here you can define the HTML ALT text for your overlay image.', 'divitorque'),
				'type'        => 'text',
				'toggle_slug' => 'content',
				'show_if'     => array(
					'use_overlay' => 'on',
			...
			'trigger_element'  => array(
				'label'       => esc_html__('Button Element', 'divitorque'),
				'description' => esc_html__('Here you can select button element for the video popup.', 'divitorque'),
				'type'        => 'select',
				'toggle_slug' => 'content',
				'default'     => 'icon',
				'options'     => array(
					'icon'      => esc_html__('Icon', 'divitorque'),
					'text'      => esc_html__('Text', 'divitorque'),
					'icon_text' => esc_html__('Icon & Text', 'divitorque'),
				),
			),
			'icon'             => array(
				'label'       => esc_html__('Select Play Icon', 'divitorque'),
				'description' => esc_html__('Here you can select different type of play icon from the video.', 'divitorque'),
				'type'        => 'select',
				'toggle_slug' => 'content',
				'default'     => '1',
				'options'     => array(
					...
					'6' => esc_html__('Icon 6', 'divitorque'),
				),
				'show_if'     => array(
			...
			'text'             => array(
				'label'       => esc_html__('Trigger Text', 'divitorque'),
				'description' => esc_html__('Define the trigger text for your popup.', 'divitorque'),
				'type'        => 'text',
				'toggle_slug' => 'content',
				'default'     => 'Play',
				'show_if'     => array(
			...
			'type'             => array(
				'label'       => esc_html__('Video Type', 'divitorque'),
				'description' => esc_html__('Define video type for the popup.', 'divitorque'),
				'type'        => 'select',
				'toggle_slug' => 'content',
				'default'     => 'yt',
				'options'     => array(
					'yt'    => esc_html__('Youtube', 'divitorque'),
					'vm'    => esc_html__('Vimeo', 'divitorque'),
					'video' => esc_html__('Custom Upload', 'divitorque'),
				),
			),
			'video_link'       => array(
				'label'       => esc_html__('Video URL', 'divitorque'),
				'description' => esc_html__('Type youtube or vimeo video url which you would like to display in the popup.', 'divitorque'),
				'type'        => 'text',
				'toggle_slug' => 'content',
				'show_if_not' => array(
					'type' => 'video',
			...
			'video'            => array(
				'label'              => esc_html__('Video MP4 File', 'divitorque'),
				'type'               => 'upload',
				'data_type'          => 'video',
			...
			'use_animation'    => array(
				'label'           => esc_html__('Use Animated Icon', 'divitorque'),
				'description'     => esc_html__('Use animated wave for your icon. For better experience please set icon background color from icon design toggle.', 'divitorque'),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'on'  => esc_html__('Yes', 'divitorque'),
			...
			'wave_bg'          => array(
				...
				'description'  => esc_html__('Here you can define custom color for the animated wave of your icon.', 'divitorque'),
				'type'         => 'color-alpha',
				'default'      => '#ffffff',
				'custom_color' => true,
				'toggle_slug'  => 'settings',
			...
			'icon_alignment'   => array(
				'label'           => esc_html__('Icon/Text Alignment', 'divitorque'),
			...
			'icon_spacing'     => array(
				'label'          => esc_html__('Spacing Between Icon and Text', 'divitorque'),
				'description'    => esc_html__('Here you can define spacing between icon and text.', 'divitorque'),
				'type'           => 'range',
				'default'        => '20px',
				'default_unit'   => 'px',
				'mobile_options' => true,
			...
			'img_height'       => array(
				...
				'description'    => esc_html__('Here you can define static height for your image.', 'divitorque'),
				'type'           => 'range',
				'default_unit'   => 'px',
				'mobile_options' => true,
				'range_settings' => array(
			...
			'icon_size'        => array(
				...
				'description'    => esc_html__('Here you can define custom size for your icon.', 'divitorque'),
				'type'           => 'range',
				'default'        => '60px',
				'default_unit'   => 'px',
				'hover'          => 'tabs',
			...
			'icon_height'      => array(
				...
				'description'    => esc_html__('Here you can define static height for your icon.', 'divitorque'),
				'type'           => 'range',
				'default'        => 'initial',
				'default_unit'   => 'px',
				'range_settings' => array(
			...
			'icon_width'       => array(
				...
				'description'    => esc_html__('Here you can define static width for your icon.', 'divitorque'),
				'type'           => 'range',
				'default'        => 'initial',
				'default_unit'   => 'px',
				'range_settings' => array(
			...
			'icon_bg'          => array(
				...
				'description'  => esc_html__('Here you can define custom background for your icon.', 'divitorque'),
				'type'         => 'color-alpha',
				'custom_color' => true,
				'toggle_slug'  => 'icon',
				'tab_slug'     => 'advanced',
			...
			'icon_radius'      => array(
				...
				'description'    => esc_html__('Here you can define the radius value for your icon border.', 'divitorque'),
				'type'           => 'range',
				'default'        => '0px',
				'default_unit'   => 'px',
				'range_settings' => array(
			...
			// Popup.
			'popup_bg'         => array(
				'label'        => esc_html__('Popup Background', 'divitorque'),
				'description'  => esc_html__('Here you can define custom background color for your popup.', 'divitorque'),
				'type'         => 'color-alpha',
				'custom_color' => true,
				'tab_slug'     => 'advanced',
			...
			'close_icon_color' => array(
				'label'        => esc_html__('Close Icon Color', 'divitorque'),
				'description'  => esc_html__('Here you can define custom color for your popup close icon.', 'divitorque'),
				'type'         => 'color-alpha',
				'custom_color' => true,
				'tab_slug'     => 'advanced',
				'default'      => '#ffffff',
		...
		$text = array(
			'use_text_box'    => array(
				'label'           => esc_html__('Use Text Box', 'divitorque'),
				'description'     => esc_html__('Here you can choose whether overlay image should be used.', 'divitorque'),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
			...
			'text_box_height' => array(
				'label'          => esc_html__('Text Box Height', 'divitorque'),
				'description'    => esc_html__('Here you can define static height for your text box.', 'divitorque'),
				'type'           => 'range',
				'default'        => '80px',
				'default_unit'   => 'px',
				'range_settings' => array(
			...
			'text_box_width'  => array(
				'label'          => esc_html__('Text Box Width', 'divitorque'),
				'description'    => esc_html__('Here you can define static width for your text box.', 'divitorque'),
				'type'           => 'range',
				'default'        => '80px',
				'default_unit'   => 'px',
				'range_settings' => array(
			...
			'text_box_bg'     => array(
				'label'        => esc_html__('Text Box Background', 'divitorque'),
				'description'  => esc_html__('Here you can define custom background for your text box.', 'divitorque'),
				'type'         => 'color-alpha',
				'custom_color' => true,
				'toggle_slug'  => 'text',
				'default'      => $this->default_color,
			...
			'text_box_radius' => array(
				'label'          => esc_html__('Text Box Border Radius', 'divitorque'),
				'description'    => esc_html__('Here you can define the radius value for your text box border.', 'divitorque'),
				'type'           => 'range',
				'default'        => '0px',
				'default_unit'   => 'px',
				'range_settings' => array(
	...
	public function get_advanced_fields_config()
	{
		...
		$advanced_fields['fonts']['trigger'] = array(
			'css'             => array(
				'main'      => '%%order_class%% .dtp-video-modal .dtp-video-modal-text',
				'important' => 'all',
			),
			'tab_slug'        => 'advanced',
			'toggle_slug'     => 'text',
	...
	protected function render_trigger($icon)
	{
		...
		if ('text' !== $this->props['trigger_element']) {
			...
			$svg_icon = sprintf('<span class="dtp-video-modal-icon">%1$s</span>', $icons[$icon]);
		}

		if ('icon' !== $this->props['trigger_element']) {
			$text = sprintf('<span class="dtp-video-modal-text">%1$s</span>', $this->props['text']);
		}
	...
	{
		wp_enqueue_style('torq-magnific-popup');
		wp_enqueue_script('torq-magnific-popup');
		wp_enqueue_style('torq-video-modal');
		wp_enqueue_script('torq-video-modal');
		$inline_modal     = '';
		...
		$data_modal       = 'video' === $type ? sprintf('data-mfp-src="#dtp-video-modal-%1$s"', $order_number) : '';

		// popup style.
		ET_Builder_Element::set_style(
			$render_slug,
			array(
				'selector'    => ".dtp-video-modal-{$order_number} .mfp-bg",
		...
		ET_Builder_Element::set_style(
			$render_slug,
			array(
				'selector'    => ".dtp-video-modal-{$order_number} .mfp-iframe-holder .mfp-close",
		...
		if ('video' === $type) {
			$inline_modal = sprintf(
				'<div class="mfp-hide dtp-modal" id="dtp-video-modal-%1$s" data-order="%1$s">
                    <div class="dtp-video-wrap">
		...
		if ('on' === $use_overlay) {
			$img_overlay = sprintf(
				'<div class="dtp-video-modal-figure">
					<img src="%1$s" alt="%2$s"/>
				</div>',
				$image,
				$image_alt
		...
		return sprintf(
			'<div class="dtp-module dtp-video-modal">
                %5$s
                <div class="dtp-video-modal-wrap">
					<a
						class="dtp-video-modal-trigger dtp-popup-%6$s"
						data-order="%4$s"
						data-type="%6$s"
						href="%3$s"
						%7$s
	...
	protected function apply_css($render_slug)
	{
		...
		$this->get_responsive_styles(
			'icon_alignment',
			'%%order_class%% .dtp-video-modal-icon',
		...
		if ('text' !== $trigger_element) {
			ET_Builder_Element::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .dtp-video-modal svg',
			...
			if (!empty($icon_color_hover)) {
				ET_Builder_Element::set_style(
					$render_slug,
					array(
						'selector'    => '%%order_class%%:hover .dtp-video-modal svg',
			...
			$this->get_responsive_styles(
				'icon_height',
				'%%order_class%% .dtp-video-modal .dtp-video-modal-icon',
			...
			$this->get_responsive_styles(
				'icon_size',
				'%%order_class%% .dtp-video-modal-icon svg',
				array('primary' => 'width'),
				array('default' => '60px'),
				$render_slug
			);
			...
			if (!empty($icon_size_hover)) {
				ET_Builder_Element::set_style(
					$render_slug,
					array(
						'selector'    => '%%order_class%%:hover .dtp-video-modal-icon svg',
			...
			ET_Builder_Element::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .dtp-video-modal-icon svg',
			...
			if (!empty($icon_bg)) {
				ET_Builder_Element::set_style(
					$render_slug,
					array(
						'selector'    => '%%order_class%% .dtp-video-modal-icon',
			...
			if (!empty($icon_bg_hover)) {
				ET_Builder_Element::set_style(
					$render_slug,
					array(
						'selector'    => '%%order_class%%:hover .dtp-video-modal-icon',
		...
		if ('icon' !== $trigger_element) {
			if ('on' === $use_text_box) {
				...
				$this->get_responsive_styles(
					'text_box_height',
					'%%order_class%% .dtp-video-modal .dtp-video-modal-text',
					array('primary' => 'height'),
					array('default' => '80px'),
					$render_slug
				);
				...
				if (!empty($text_box_bg_hover)) {
					ET_Builder_Element::set_style(
						$render_slug,
						array(
							'selector'    => '%%order_class%%:hover .dtp-video-modal .dtp-video-modal-text',
			...
			if ('on' === $use_overlay) {
				ET_Builder_Element::set_style(
					$render_slug,
					array(
						'selector'    => '%%order_class%% .dtp-video-modal-trigger',
		...
		if ('on' === $use_overlay) {
			$this->get_responsive_styles(
				'img_height',
				'%%order_class%% .dtp-video-modal-figure',
				array('primary' => 'height'),
				array('default' => 'auto'),
				$render_slug
			);
			...
			$this->get_custom_bg_style(
				$render_slug,
				'image',
				'%%order_class%% .dtp-video-modal-figure:before',
				'%%order_class%%:hover .dtp-video-modal-figure:before'
			);
		...
		// Animation.
		if ('on' === $use_animation) {
			$selector = '%%order_class%% .dtp-video-modal a:after';
			if ('icon_text' === $trigger_element) {
				$selector = '%%order_class%% .dtp-video-modal .dtp-video-modal-icon:after';
			}
